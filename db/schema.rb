...
ActiveRecord::Schema.define(version: 20201104155354) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.index ["group_event_id"], name: "index_addresses_on_group_event_id"
  end
  ...
  add_foreign_key "addresses", "group_events"
